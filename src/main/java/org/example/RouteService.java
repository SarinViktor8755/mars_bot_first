...
//    }
    ...
    public static float get_percentage_stage(int сurrent_distance){
        System.out.println(etermine_distance(сurrent_distance));
        float a = etermine_distance(сurrent_distance);
        float b = (сurrent_distance - etermine_distance(сurrent_distance)) * -1;
